 ...
 */
public class ServidorSoket2View extends FrameView {

ServerSocket serverSocket, serverSocket2;
Socket socketCliente, socketCliente2;
//DefaultTableModel modelo;
    
    public ServidorSoket2View(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ServidorSoket2App.getApplication().getMainFrame();
            aboutBox = new ServidorSoket2AboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ServidorSoket2App.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(servidorsoket2.ServidorSoket2App.class).getContext().getResourceMap(ServidorSoket2View.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(servidorsoket2.ServidorSoket2App.class).getContext().getActionMap(ServidorSoket2View.class, this);
